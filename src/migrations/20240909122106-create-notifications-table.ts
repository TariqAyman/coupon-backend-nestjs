...
export class CreateNotificationsTable20240909122106 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (foreignKeys) {
      await Promise.all(foreignKeys.map(fk => queryRunner.dropForeignKey('notifications', fk)));
    }
